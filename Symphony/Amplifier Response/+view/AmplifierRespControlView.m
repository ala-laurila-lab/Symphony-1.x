    ...
    methods
        ...
        function obj = AmplifierRespControlView(model, controller, layout)
            ...
            for i = 1:length(channels)
                obj.channelSelectBoxes.(channels{i}) = uicontrol(amplifierLayout,...
                    'Style','checkbox',...
            ...
            scalingLayout  = uiextras.VBox(....
                'Parent', controlLayout);
            obj.sliderXText = uicontrol(scalingLayout,...
                'Style','text',...
                'String','Horizontal Scale X min = 0.0 & X max = 1.0 ');
            obj.sliderX = uicontrol(scalingLayout,...
                'Style','slider',...
                ...
                'Tag',channels{i});
            obj.sliderYText = uicontrol(scalingLayout,'Style','text',...
                'String','Vertical Scale');
            obj.sliderY = uicontrol(scalingLayout,'Style','slider',...
                'Min',0,'Max',100,'Value',25,...
                'SliderStep',[0.05 0.2],...
                'String','Vertical Scale',...
            ...
            for i = 1:length(channels)
                obj.channelRadioBtns.(channels{i}) = uicontrol(scalingLabelLayout,...
                    'Style','radiobutton',...
                    'String',sprintf('Scale Channel %d',i),...
                    'callback', @(h, d)selectScalingChannel(obj.controller ,h ,d ,obj.channelRadioBtns),...
                    'Tag',channels{i},...
                    'Value',0);
            end
            
            controlLayout.Widths = [-1 -6 -1];
        end
    end
end
