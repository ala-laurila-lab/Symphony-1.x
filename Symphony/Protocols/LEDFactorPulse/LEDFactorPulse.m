    ...
    methods
        ...
        function tf = isequal(obj, other)
            tf= isequal(class(obj), class(other)) && ...
                isequal(obj.initialPulseAmplitude, other.initialPulseAmplitude) && ...
                isequal(obj.scalingFactor, other.scalingFactor) && ...
                isequal(obj.preTime, other.preTime) && ...
                isequal(obj.stimTime, other.stimTime) && ...
                isequal(obj.tailTime, other.tailTime) && ...
                isequal(obj.numberOfIntensities, other.numberOfIntensities) && ...
                isequal(obj.numberOfRepeats, other.numberOfRepeats) && ...
                isequal(obj.interpulseInterval, other.interpulseInterval) && ...
                isequal(obj.ampHoldSignal, other.ampHoldSignal) && ...
                isequal(obj.ampMode, other.ampMode) && ...
                isequal(obj.LEDBackground, other.LEDBackground);
        end
    end
